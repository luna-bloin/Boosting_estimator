...
for mem in tqdm(range(1,31)): #TODO: what about extra members 31-35?
    file = sorted(glob.glob(in_path+f"b.e212.B*cmip6.f09_g17.001.2005.ens{mem:03d}/archive/atm/hist/b.e212.B*cmip6.f09_g17.001.2005.ens{mem:03d}.cam.h1.*-01-01-00000.nc"))
